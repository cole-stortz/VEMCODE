...
This document is the primary developer reference for VEMCODE. Keep it up to date as the codebase evolves. New contributors should read this before touching any code.
